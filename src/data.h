...
typedef struct{
int x,y,w,h,w_orig,h_orig, w_rotate, h_rotate;
float rad;
} ratio_box;
...
//data load_data_detection(int n, char **paths, int m, int w, int h, int c, int boxes, int classes, int use_flip, float jitter, float equal_ratio, float hue, float saturation, float exposure, int small_object, double sigma, float random_rotate, float random_wrap)
