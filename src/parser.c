...
void parse_net_options(list *options, network *net)
{
    ...
    net->random_rotate = option_find_int_quiet(options, "random_rotate",0);
    net->random_wrap = option_find_float_quiet(options, "random_wrap", 0.0);
...
network *parse_network_cfg(char *filename)
{
    ...
    while(n){
        ...
        //l.random_rotate = option_find_int_quiet(options, "random_rotate", 90);
        //l.random_wrap = option_find_float_quiet(options, "random_wrap",0.02 );
